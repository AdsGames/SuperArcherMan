...

{
	 ...
	 * 29/5/15
	 */
	// Importsimport org.flixel.FlxPoint;
import allanly.bow;
...
{
	// Image
	[Embed(source = '../../assets/images/player.png')] private var picChar:Class;

	// Sayings
	[Embed(source = "../../assets/sounds/jim_saying1.mp3")] private var saying1:Class;
	[Embed(source = "../../assets/sounds/jim_saying2.mp3")] private var saying2:Class;
	[Embed(source = "../../assets/sounds/jim_saying3.mp3")] private var saying3:Class;
	[Embed(source = "../../assets/sounds/jim_saying4.mp3")] private var saying4:Class;

	[Embed(source = "../../assets/sounds/cheer.mp3")] private var winSound:Class;

	// Sound
	[Embed(source = "../../assets/sounds/bell.mp3")] private var soundDeath:Class;
